    ...
    : describe("Nft Marketplace Unit Tests", function () {
          ...
          describe("cancelListing", function () {
              ...
              it("emits event and removes listing", async function () {
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
                  expect(await nftMarketplace.cancelListing(basicNft.address, TOKEN_ID)).to.emit("NftMarketPlace__ItemCanceled")
                  const listing = await nftMarketplace.getListing(basicNft.address, TOKEN_ID)
          ...
          describe("buyItem", function () {
              ...
              it("transfers the nft to the buyer and updates internal proceeds record", async function () {
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
                  nftMarketplace = nftMarketplaceContract.connect(user)
                  expect(await nftMarketplace.buyItem(basicNft.address, TOKEN_ID, { value: PRICE })).to.emit("NftMarketPlace__ItemBought")
          ...
          describe("updateListing", function () {
              ...
              it("updates the price of the item", async function () {
                  ...
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
                  expect( await nftMarketplace.updateListing(basicNft.address, TOKEN_ID, updatedPrice)).to.emit("NftMarketPlace__ItemListed")
                  const listing = await nftMarketplace.getListing(basicNft.address, TOKEN_ID)
